...
elseif manner == 3
    subspace=3;Rdims=[512,512,subspace];mu=1.1e-2;eta=0.7e-2; para.tao=0.007; 
    para.lambda=0.03;para.r=14; para.r_max=20;para.gamma=1.4;para.gama=100;
end
